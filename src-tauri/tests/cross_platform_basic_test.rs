...
async fn test_cross_platform_unicode_handling() {
    ...
    let unicode_test_cases = vec![
        ("config_中文.json", serde_json::json!({"app_name": "AI Manager 中文版", "description": "测试中文支持"})),
        ("config_日本語.json", serde_json::json!({"app_name": "AI Manager 日本語版", "description": "日本語テスト"})),
        ("config_한국어.json", serde_json::json!({"app_name": "AI Manager 한국어판", "description": "한국어 테스트"})),
        ("config_العربية.json", serde_json::json!({"app_name": "AI Manager بالعربية", "description": "اختبار باللغة العربية"})),
        ("config_файл.json", serde_json::json!({"app_name": "AI Manager русский", "description": "Тест на русском"})),
    ];
